...
<div class="modal fade bs-example-modal-lg" style="display: none !important;" id="GraphModal" tabindex="-1"
...
<section class="content-header">
	<h4>
		<?php $raccount = $account;
		echo $account . " - " . $nameaddress ?>
	</h4>
	<ol class="breadcrumb">
...
<section class="content">
	<div class="nav-tabs-custom">
		<ul class="nav nav-tabs" role="tablist" onclick="clickedOnTab(event);">
			<li role="presentation" class="active"><a href="#proSalesAnalysis" id="proSalesAnalysisTab" role="tab"
					data-toggle="tab" aria-expanded="false">Sales Analysis</a></li>
			<li role="presentation" class=""><a href="#pacsalesvstarget" id="pacsalesvstargetTab" role="tab" data-toggle="tab"
					aria-expanded="false"
					data-params='{"action" : "customerPACSalesVsTarget/<?= date("Y") . date("m"); ?>", "accountId" : "<?= base64_encode($account); ?>"}'>Sales
					vs. Target</a></li>
			<li role="presentation" class=""><a href="#proBalances" id="proBalancesTab" role="tab" data-toggle="tab"
					aria-expanded="false"
					data-params='{"action" : "customerDetailsBalance", "accountId" : "<?= base64_encode($account); ?>", "editId" : "internaltext"}'>Balances</a>
			</li>
			<li role="presentation" class=""><a href="#proQuotes" id="proQuotesTab" role="tab" data-toggle="tab"
					aria-expanded="false"
					data-params='{"action" : "customerDetailsQuotes", "accountId" : "<?= base64_encode($account); ?>"}'>Quotes</a>
			</li>
			<li role="presentation" class=""><a href="#proOrders" id="proOrdersTab" role="tab" data-toggle="tab"
					aria-expanded="false"
					data-params='{"action" : "customerDetailsOrders", "accountId" : "<?= base64_encode($account); ?>"}'>Orders</a>
			</li>
			<li role="presentation" class=""><a href="#proTerms" id="proTermsTab" role="tab" data-toggle="tab"
					aria-expanded="false"
					data-params='{"action" : "customerDetailsTerms", "accountId" : "<?= base64_encode($account); ?>", "editId" : "discnt"}'>Terms</a>
			</li>
			<li role="presentation" class=""><a href="#proDetails" id="proDetailsTab" role="tab" data-toggle="tab"
					aria-expanded="false"
					data-params='{"action" : "customerDetailsDetail", "accountId" : "<?= base64_encode($account); ?>"}'>Details</a>
			</li>
			<li role="presentation" class=""><a href="#targets" id="targetsTab" role="tab" data-toggle="tab"
					aria-expanded="false"
					data-params='{"action" : "customerPACTargets", "accountId" : "<?= base64_encode($account); ?>"}'>Targets</a>
			</li>
			<li role="presentation" class=""><a href="#customer_contacts" id="customer_contactsTab" role="tab"
					data-toggle="tab" aria-expanded="false"
					data-params='{"action" : "customerContacts", "accountId" : "<?= base64_encode($account); ?>", "editId" : "internaltext"}'>Contacts</a>
			</li>
			<li role="presentation" class=""><a href="#customer_tasks" id="customer_tasksTab" role="tab" data-toggle="tab"
					aria-expanded="false">Tasks</a></li>
			<li role="presentation" class=""><a href="#customer_reps" id="customer_repsTab" role="tab" data-toggle="tab"
					aria-expanded="false" data-params='{"accountId" : "<?= base64_encode($account); ?>"}'>Sales Reps</a></li>
		</ul>
					...
					<div class="col-xs-12">
						<div class="nav-tabs-custom left-tab">
							<ul class="nav nav-tabs" role="tablist">
								<li role="presentation" class="active"><a href="#pro1Charts" role="tab" data-toggle="tab"
										aria-expanded="false">Charts</a></li>
								<li role="presentation" class=""><a href="#pro1PAC1" role="tab" data-toggle="tab"
										aria-expanded="false">PAC1</a></li>
								<li role="presentation" class=""><a href="#pro1PAC2" role="tab" data-toggle="tab"
										aria-expanded="false">PAC2</a></li>
								<li role="presentation" class=""><a href="#pro1PAC3" role="tab" data-toggle="tab"
										aria-expanded="false">PAC3</a></li>
								<li role="presentation" class=""><a href="#pro1PAC4" role="tab" data-toggle="tab"
										aria-expanded="false">PAC4</a></li>
								<li role="presentation" class=""><a href="#pro1Products" role="tab" data-toggle="tab"
										aria-expanded="false">Products</a></li>
								<li role="presentation" class=""><a href="#pro1Orders" role="tab" data-toggle="tab"
							...
							<div class="tab-content">
														...
														<div class="nav-tabs-custom">
															<ul class="nav nav-tabs pull-right">
																<li class="active"><a href="#threeyearsaleschart" data-toggle="tab"
																		onclick="manage_cookie('twoyearsalesanalysischart','N')"><i
																			class="fa fa-line-chart"></i></a></li>
																<li onclick="manage_cookie('twoyearsalesanalysischart','Y')"
																	id="twoyearsalesanalysistable_nav"><a href="#threeyearsalestable" data-toggle="tab"><i
															...
															<div class="tab-content no-padding">
																<div class="tab-pane active" id="threeyearsaleschart" style="position: relative;">
																	<div class="row">
																		<div class="col-xs-12 col-sm-8 col-md-9">
																			<div class="chart" style="min-height:200px;">
																		...
																		<div class="col-md-1">
																			<ul class="chart-legend clearfix">
																				...
																				<li id="target-cml-legend" style="display:none;"><i
																						class="fa fa-circle-o text-light-blue"></i>Target Cml.</li>
																			</ul>
																		</div>
																		<div class="col-md-2">
																			<form>
																...
																<div class="tab-pane" id="threeyearsalestable"
																	...
																	<table class="table example-table table-bordered table-striped" id="customerthreeyearsalestable">
																		<?php
									...
									<div class="tab-pane" id="pro1PAC<?= $p; ?>">
										<div class="row">
											<div class="col-xs-12 col-sm-8 col-md-9 col-lg-10">
												<div class="loading_spinner"
													style="display: block;position: absolute;background-color: rgba(0,0,0,0.5);width: 100%;height: calc(100% - 15px);text-align: center;">
													<i class="fa fa-spinner fa-spin fa-fw" style="
																			color: #000;
																			scale: 2;
																			position: absolute;
												...
												<table class="table example-table pro1PAC<?= $p; ?>-example-table table-bordered table-striped">
													<thead>
														<tr>
															<th>Code</th>
															<th>Description</th>
								...
								<div class="tab-pane" id="pro1Products">
									<div class="row">
										<div class="col-xs-12 col-sm-8 col-md-9 col-lg-10">
											<table class="table product-example-table table-bordered table-striped"
												id="product-example-table">
												<thead>
													<tr>
														<th>Code</th>
														<th>PAC4</th>
								...
								<div class="tab-pane" id="pro1Orders">
									<div class="row">
										<div class="col-xs-12 col-sm-8 col-md-9 col-lg-10">
											<table class="table order-table table-bordered table-striped sales-analysis-orders"
					...
					<div class="col-xs-12">
						<div class="content_box">
							<div class="loading-placeholder">
								<span>Loading Balances...</span><span><img
										src="../../public/images/loading-gears-animation-11-2.gif" /></span>
							</div>
						</div>
					</div><!-- /.col -->
				</div><!-- /.row -->
			...
			<div class="tab-pane" id="proQuotes">
				<div class="row">
					<div class="col-xs-12">
						<div class="content_box">
							<div class="loading-placeholder">
								<span>Loading Quotes...</span><span><img
										src="../../public/images/loading-gears-animation-11-2.gif" /></span>
							</div>
						</div>
					</div><!-- /.col -->
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="content_box box-body">
							<div class="loading-placeholder">
								<span>Loading Orders...</span><span><img
										src="../../public/images/loading-gears-animation-11-2.gif" /></span>
							</div>
						</div>
					</div><!-- /.col -->
			...
			<div class="tab-pane" id="proTerms">
				<div class="row">
					<div class="col-xs-12">
						<div class="content_box">
							<div class="loading-placeholder">
								<span>Loading Terms...</span><span><img
										src="../../public/images/loading-gears-animation-11-2.gif" /></span>
							</div>
						</div>
					</div><!-- /.col -->
			...
			<div class="tab-pane" id="proDetails">
				<div class="row">
					<div class="col-xs-12">
						<div class="content_box">
							<div class="loading-placeholder">
								<span>Loading Details...</span><span><img
										src="../../public/images/loading-gears-animation-11-2.gif" /></span>
							</div>
						</div>
					</div><!-- /.col -->
			...
			<div class="tab-pane" id="targets">
				<div class="row">
					<div class="col-xs-12">
						<div class="content_box">
							<div class="loading-placeholder">
								<span>Loading Targets...</span><span><img
										src="../../public/images/loading-gears-animation-11-2.gif" /></span>
							</div>
						</div>
					</div><!-- /.col -->
			...
			<div class="tab-pane" id="customer_contacts">
				<div class="row">
					<div class="col-xs-12">
						<div class="content_box">
							<div class="loading-placeholder">
								<span>Loading Contacts...</span><span><img
										src="../../public/images/loading-gears-animation-11-2.gif" /></span>
							</div>
						</div>
					</div><!-- /.col -->
					...
					<div class="col-xs-12">
						<div class="content_box">
							<div class="btn-group btn-group-toggle" data-toggle="buttons">
								<label class="btn btn-secondary task-list-selectors active" data-overdue="true"
									onclick="onActivate(event, '<?= $account; ?>');">
									<input type="radio" name="options" id="option1" autocomplete="off" checked /> Overdue Tasks
								</label>
								<label class="btn btn-secondary task-list-selectors" data-overdue="false"
									onclick="onActivate(event, '<?= $account; ?>');">
							...
							<button type="submit" name="addnew" class="btn btn-success pull-right bottom5"
								onclick="return addTask('<?= $account; ?>');"><i class="fa fa-fw fa-plus-circle"></i>Add task</button>
									...
									<div class="box">
										<div class="box-body">
											<div class="alert alert-success alert-dismissible hidden" id="statusAndMessage">
												...
												<strong id="status">Success!</strong> <span id="statusMessage">Indicates a successful or
			...
			<div class="tab-pane" id="customer_reps">
				<div class="row">
					<div class="col-xs-12">
						<div class="content_box">
							<button type="submit" name="addnew" class="btn btn-success pull-right bottom5"
								onclick="return openModal('#addRepModal', 'newRep/<?= base64_encode($account); ?>');"><i
			...
			<div class="tab-pane" id="pacsalesvstarget">
				<div class="row">
					<div class="col-xs-12">
						<div class="content_box">
							<div class="loading-placeholder">
								<span>Customer PAC Sales vs Target</span><span><img
										src="../../public/images/loading-gears-animation-11-2.gif" /></span>
							</div>
						</div>
					</div><!-- /.col -->
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					...
					<a href="javascript:hidePreviousBtn();" class="btn btn-info btn-sm previous hidden" id="backToDetails"
						data-taskid="" data-edit="">&raquo; Task Details</a>
					<h4 class="modal-title" id="myLargeModalLabel">...</h4>
				</div>
				<div class="modal-body">
					...
			...
			$('.sales-analysis-orders').DataTable(
				{
					processing: true,
					language: {
						processing: `<div class="overlay h2 m-0" style="margin: 0px;display: block;position: absolute;">
	...
	<script type="text/javascript">
		$(function () {
			$.ajax({
				url: '<?= base_url() ?>customer/getTwoYearsTargetTable',
				data: { account: '<?= base64_encode($account); ?>' },
				method: 'post',
				dataType: 'json',
				success: function (data) {
					...
					$('#customerthreeyearsalestable').append(resp);
					$('#customerthreeyearsalestable ').prev(".loading_spinner").remove();
				}
			});
			...
			if(count == 0){
				$.ajax({
					url: '<?= base_url() ?>customer/GetThreeYearChartCanvas',
					data: { account: '<?= base64_encode($account); ?>' },
					method: 'post',
					dataType: 'json',
					success: function (data) {
			...
			for (let i = 1; i <= 4 ; i ++) {
				$.ajax({
					url: '<?= base_url() ?>customer/getPACTable',
					data: { account: '<?= base64_encode($account); ?>', index: i},
					method: 'post',
					dataType: 'json',
					success: function (data) {
						const {
						...
						const canSeeMargins = '<?= $canSeeMargins; ?>';
						const response = displayPAC(r_pac, canSeeMargins, 1, account, '<?= base_url() ?>');
						$(".pro1PAC"+i+"-example-table ").prev(".loading_spinner").remove();
						$(".pro1PAC"+i+"-example-table tbody").append(response['html']);
						...
						let foothtml = `
							<tr style="background-color: #e1e1e1; font-style: italic; font-weight: bold; color: black;" class="total-row">
								...
								<td class="hastotals 3">` + number_format(response['totals']['salesytd']) + `</td>
								<td class="hastotals 4">` + number_format(response['totals']['qtyytd']) + `</td>
								<td class="hastotals 5">` + getDiffPercentageFormatted(response['totals']['salesytd'], response['totals']['YoY1Sales'] + response['totals']['YoY1ProRataAdjustment']) + `</td>
								<td class="hastotals 6">` + getDiffPercentageFormatted(response['totals']['qtyytd'], response['totals']['YoY1Qty']) + `</td>
								<td class="hastotals 7">` + number_format(response['totals']['YoY1Sales'] + response['totals']['YoY1ProRataAdjustment'], 2) + `</td>
								<td class="hastotals 8">` + number_format(response['totals']['YoY1Qty']) + `</td>
								<td class="hastotals 9">` + number_format(response['totals']['YoY2Sales']) + `</td>
								<td class="hastotals 10">` + number_format(response['totals']['YoY2Qty']) + `</td>`;
						if (canSeeMargins) {
							foothtml += `
								<td class="hastotals 11">` + getDiffMargin(response['totals']['salesmtd'], response['totals']['costsmtd']) + `</td>
								<td class="hastotals 12">` + getDiffMargin(response['totals']['salesytd'], response['totals']['costsytd']) + `</td>`;
						}

						$(".pro1PAC"+i+"-example-table tfoot").append(foothtml);
						var pacTable = $(".pro1PAC"+i+"-example-table").DataTable(exportFunctions);
						pacTable.on('draw', function () {
							pacTable.columns('.sum', { search: 'applied' }).every(function () {
								calculateTotals(this, pacTable, calculatedColumns);
							});
						});
