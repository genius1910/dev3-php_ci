  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <div class="box">
        ...
        -->
          <button type="button" id="uploadTargetsBulk" class="btn btn-success pull-right"
            onclick="openAdduploadTargetForm();"><i class="fa fa-fw fa-calendar-plus-o"></i> Upload target(s)</button>
          <table class="table table-bordered table-striped" id="customer_list_table">
            ...
            <tfoot>
              ...
              <tr style="background-color: #e1e1e1;font-style: italic;font-weight: bold;color: black;"
                ...
                <td class="hastotal" data-value="sales-lastyear">Sales
                  <?php $curryear = date('Y');
                  echo $curryear - 1; ?> YTD
                </td>
                <td class="hastotal" data-value="ysales1">Sales
                  <?php $curryear = date('Y');
                  echo $curryear - 1; ?>
                </td>
                <td class="hastotal" data-value="diff">Diff %</td>
                <td class="hastotal" data-value="sales-last-to-lastyear">Sales
                  <?php echo $curryear - 2; ?> YTD
                </td>
                <td class="hastotal" data-value="ysales2">Sales
                  <?php echo $curryear - 2; ?>
                </td>
