...
<?php
	...
	$year0startindex = ($curmonth - $yearstartmonth) + 12; // e.g. msales8 if we're in May now and year starts in September
	$year1startindex = $year0startindex + 12;
	$year2startindex = $year1startindex + 12;
...
//	for($x = intval($curmonth); $x < $curmonth + 12; $x++)
	for($x = $year0startindex + 1; $x < $year0startindex + 12; $x++)
	{
...
//	for($x = intval($curmonth) + 12; $x < $curmonth + 23; $x++)
	for($x = $year0startindex + 12; $x < $year0startindex + 23; $x++)
	{
		$yearstr = $yearstr."msales$x";
...
//	for($x = intval($curmonth) + 12; $x < $curmonth + 23; $x++)
	for($x = $year0startindex + 24; $x < 36; $x++)
	{
		$yearstr = $yearstr."msales$x";
