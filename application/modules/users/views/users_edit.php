...
<section class="content">
  <div class="nav-tabs-custom">
    <ul class="nav nav-tabs" role="tablist">
      ...
      <li role="presentation" class="" id="showiftarget"><a href="#target" role="tab" data-toggle="tab"
          aria-expanded="false">Targets</a></li>
      <li role="presentation" class="" id="showifkpi"><a href="#kpi" role="tab" data-toggle="tab"
          aria-expanded="false">KPI</a></li>
      <li role="presentation" class="" id="showSalesRep" data-user="<?php echo $userDetail['userid'];?>"><a
          href="#salesRepBlock" role="tab" data-toggle="tab" aria-expanded="false">Sales Rep</a></li>
    </ul>
      ...
      <div class="active tab-pane" id="details">
        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-md-8">
            ...
            <input type="hidden" name="hiddentype" value="<?= $userDetail['hiddentype'] ?>" />
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="licencetype" id="licencetype" disabled>
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="defaultmodule" id="defaultmodule" required <?php if($userDetail['licencetype'] == 'S'):?> disabled <?php endif ?>>
                <option value="S" <?php if($userDetail['defaultmodule'] == 'S') { echo "selected";} else { echo "";}?>>(S)ales</option>
                <option value="I" <?php if($userDetail['defaultmodule'] == 'I') { echo "selected";} else { echo "";}?>>(I)nventory Management</option>
              </select>
            </div>
                    ...
                    <div class="box-body">
                      ...
                      <div class="box-footer no-border">
                        ...
                        <button type="button" class="btn btn-success pull-left" onclick="openAdduploadTargetForm();"><i
                            class="fa fa-fw fa-calendar-plus-o"></i> Upload target(s)</button>
